...
var linhaDiamante = [
    "Diamante - Júlio Prestes",
    "Diamante - Palmeiras-Barra Funda",
    "Diamante - Lapa",
    "Diamante - Domingos De Moraes",
    "Diamante - Imperatriz Leopoldina",
    "Diamante - Presidente Altino",
    "Diamante - Osasco",
    "Diamante - Comandante Sampaio",
    "Diamante - Quitaúna",
    "Diamante - General Miguel Costa",
    "Diamante - Carapicuíba",
    "Diamante - Santa Terezinha",
    "Diamante - Antonio João",
    "Diamante - Barueri",
    "Diamante - Jardim Belval",
    "Diamante - Jardim Silveira",
    "Diamante - Jandira",
    "Diamante - Sagrado Coração",
    "Diamante - Engenheiro Cardoso",
    "Diamante - Itapevi",
    "Diamante - Santa Rita",
    "Diamante - Ambuitá",
    "Diamante - Amador Bueno"
];
var linhaEsmeralda = [
    "Esmeralda - Osasco",
    "Esmeralda - Presidente Altino",
    "Esmeralda - Ceasa",
    "Esmeralda - Villa Lobos-Jaguaré",
    "Esmeralda - Cidade Universitária",
    "Esmeralda - Pinheiros",
    "Esmeralda - Hebraica-Rebouças",
    "Esmeralda - Cidade Jardim",
    "Esmeralda - Vila Olímpia",
    "Esmeralda - Berrini",
    "Esmeralda - Morumbi",
    "Esmeralda - Granja Julieta",
    "Esmeralda - João Dias",
    "Esmeralda - Santo Amaro",
    "Esmeralda - Socorro",
    "Esmeralda - Jurubatuba",
    "Esmeralda - Autódromo",
    "Esmeralda - Primavera-Interlagos",
    "Esmeralda - Grajaú",
    "Esmeralda - Bruno Covas/Mendes-Vila Natal",
    "Esmeralda - Estação Varginha"
];
var linhaTurquesa = [
